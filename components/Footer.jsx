  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex  px-8 flex-col md:flex-row mb-4 justify-between items-start md:items-center">
        ...
        {/* Copyright */}
        <div className="text-gray-800 py-9 text-sm text-center font-bold bg-[#D9EDD9]">
