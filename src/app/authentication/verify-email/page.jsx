...
export default function VerifyEmailPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex justify-center items-center">
     <div className="flex  w-[84%] bg-white shadow-sm rounded-xl relative overflow-hidden">
       {/* Left side - Form */}
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <p className="text-gray-600">
                  Enter the 4-digit code sent to oyarzabal@gmail.com
                </p>
                ...
                <div className="text-center text-sm text-gray-500">
                  ...
                  <button className="text-gray-700 hover:underline">
                    Resend it {formatTime(countdown)} sec
                  </button>
                </div>
              </div>
            </div>
