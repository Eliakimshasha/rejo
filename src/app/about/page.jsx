  ...
  return (
    <div>
      <div className="relative md:h-[90vh] h-[50vh] w-full overflow-hidden">
        ...
        <h1 className="absolute inset-0 flex items-center justify-center text-3xl md:text-5xl z-20 text-black font-medium">
          ABOUT JOINTLY
        </h1>
      </div>
        ...
        <section className="py-16 px-4 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="md:text-4xl text-2xl font-medium text-gray-800 mb-4">
              Welcome to Jointly. Travel Made Easy, Payment Made Flexible
            </h2>
          </div>
        ...
        <section className="py-16 px-4 max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-green-50 rounded-2xl p-8 md:py-14">
              <div className="flex items-center space-x-4 justify-between md:w-[70%] w-full  mx-auto">
                <div className="">
                <Image src={customer} alt="customer support" className="w-14 h-14"/>
                </div>
                <h3 className="text-xl font-medium text-gray-800">
                  24/7 Customer Support
                </h3>
